<template>
  <div
    ref="pageRef"
    class="aaa-container geo-template-page geo-page theme-light"
        ...
        <div class="panel-scroll">
          ...
          <section class="geo-card control-section">
            ...
            <el-select
              ...
              class="theme-select"
              popper-class="geo-select-popper geo-select-popper-light"
              placeholder="请选择几何体"
            >
              <el-option
