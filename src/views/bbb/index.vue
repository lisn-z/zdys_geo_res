<template>
  <div ref="pageRef" class="bbb-container geo-template-page geo-page theme-light layout-floating"
      ...
      <aside id="left-panel" class="side-panel left-panel" :class="{ collapsed: leftCollapsed }">
        <div class="panel-scroll">
          ...
          <section class="geo-card control-section">
            ...
            <el-select v-model="selectedShape" class="theme-select"
              popper-class="geo-select-popper geo-select-popper-light" placeholder="请选择几何体">
            ...
            <div class="color-control-row">
              ...
              <el-color-picker v-model="objectColor" class="theme-color-picker" />
            </div>
          ...
          <section class="geo-card control-section">
            ...
            <el-slider v-model="objectScale" :min="0.5" :max="2" :step="0.1" :show-tooltip="false" />
            ...
            <div class="number-control-row">
              ...
              <el-input-number v-model="objectSpacing" class="theme-input-number" :min="2" :max="6" :step="0.5"
          ...
          <section class="geo-card control-section">
            ...
            <el-slider v-model="rotationSpeed" :min="0" :max="3" :step="0.1" :show-tooltip="false" />
            ...
            <el-slider v-model="lightIntensity" :min="0.2" :max="3" :step="0.1" :show-tooltip="false" />
          ...
          <section class="geo-card control-section">
            <div class="color-control-row first-control-row">
              ...
              <el-color-picker v-model="sceneBackground" class="theme-color-picker" />
            </div>

            <h3 class="section-title preset-title">场景预设</h3>

            <div class="option-grid">
              <button v-for="item in presets" :key="item.value" type="button" class="theme-btn option-btn" :class="{
        ...
        <div class="stage-content">
          ...
          <div class="stage-placeholder template-prompt-card">
            <div class="template-prompt-head">
              ...
              <button type="button" class="theme-btn option-btn copy-prompt-btn" @click="copyTemplatePrompt">
                {{ copyPromptText }}
              </button>
            </div>

            <pre class="template-prompt-text" v-text="aiTemplatePrompt"></pre>
      ...
      <aside id="right-panel" class="side-panel right-panel" :class="{ collapsed: rightCollapsed }">
        <div class="panel-scroll">
          ...
          <el-collapse v-model="activePanels" class="analysis-collapse">
            <el-collapse-item title="面板用途" name="parameters">
              <div class="collapse-content">
                <p>用于展示模型类型、缩放比例、旋转速度和运行状态。</p>
              </div>
            </el-collapse-item>

            <el-collapse-item title="开发提示" name="tips">
              <div class="collapse-content">
                <p>
                  右侧面板适合放置知识说明、实时数值、
                  计算结果、图例和课堂提示。
...
const sceneBackground = ref('#eaf4f8')
